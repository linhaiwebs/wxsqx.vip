  ...
  return (
    <section className="mt-3">
      <div className="glass-panel rounded-xl p-5 flex flex-col gap-3 border-l-4 border-l-xb-secondary relative overflow-hidden">
        ...
        <button className="w-full bg-xb-surface-tint text-white font-body font-semibold rounded-lg h-11 mt-1 hover:bg-xb-primary transition-colors flex justify-center items-center gap-2">
