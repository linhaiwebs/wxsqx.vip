...
const BASE_URL = 'https://tsdy.live';
  ...
  return (
    <footer className="relative z-10 border-t-2 border-white/20 mt-12">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 py-8">
        ...
        <div className="hidden md:block bg-slate-800/90 backdrop-blur-sm border-2 border-tsdy-400/50 rounded-lg p-6 mb-8 shadow-xl">
          <div className="flex items-start gap-4">
            <div className="bg-tsdy-900/50 p-3 rounded-lg flex-shrink-0">
              <Shield className="w-6 h-6 text-tsdy-400" />
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-bold text-tsdy-300 mb-3 flex items-center gap-2">
                <Scale className="w-5 h-5" />
                金融商品取引法に基づく重要事項
              </h3>

              <div className="space-y-3 text-sm leading-relaxed text-slate-200">
                <div className="bg-slate-700/70 rounded p-3 border-l-4 border-tsdy-500">
                  <p className="font-bold text-tsdy-300 mb-2">【サービスの性質】</p>
                  <p>
                ...
                <div className="bg-slate-700/70 rounded p-3 border-l-4 border-red-500">
                ...
                <div className="bg-slate-700/70 rounded p-3 border-l-4 border-tsdy-500">
                  <p className="font-bold text-tsdy-300 mb-2">【情報の正確性について】</p>
                  <p>
        ...
        <div className="md:hidden bg-tsdy-500/10 backdrop-blur-md border border-tsdy-400/50 rounded-xl p-4 text-center mb-6">
        ...
        <div className="border-t-2 border-white/30 pt-6">
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li>
                  <a
                    ...
                    className="text-white drop-shadow-lg hover:text-tsdy-300 hover:underline flex items-center gap-1"
                  >
                ...
                <li>
                  <a
                    href={`${BASE_URL}/specified-commercial-transaction-act`}
                    className="text-white drop-shadow-lg hover:text-tsdy-300 hover:underline flex items-center gap-1"
                  >
          ...
          <div className="border-t border-white/30 pt-4 text-center">
            <div className="text-xs sm:text-sm text-white drop-shadow-lg mb-2 font-medium space-y-1">
              <p className="mt-2">&copy; {currentYear} TSDY. All rights reserved.</p>
            </div>
