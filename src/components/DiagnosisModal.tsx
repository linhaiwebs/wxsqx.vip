        ...
        <div ref={contentRef} className="flex flex-col gap-2 overflow-y-auto max-h-[50vh] text-left z-10">
          {isConnecting ? (
            ...
            <>
              ...
              <button onClick={onLineConversion} className="w-full bg-xb-surface-tint text-white font-body font-semibold rounded-lg h-[44px] mt-2 hover:bg-xb-primary transition-colors flex justify-center items-center gap-2">
