...
export default function SpecifiedCommercialTransactionAct() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-qdhs-bg via-qdhs-surface to-qdhs-bg">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <a
          href="https://qdhs.live/"
          className="inline-flex items-center gap-2 text-qdhs-red hover:text-qdhs-red mb-6"
        >
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-qdhs-red/10 p-3 rounded-lg">
              <FileText className="w-6 h-6 text-qdhs-red" />
            </div>
            <h1 className="text-3xl font-bold text-gray-900">特定商取引法に基づく表記</h1>
          </div>

          <p className="text-qdhs-on-surface leading-relaxed mb-8">
          ...
          <div className="space-y-6">
            <section className="border-b border-gray-200 pb-6">
              <div className="flex items-start gap-4">
                <div className="bg-qdhs-surface p-3 rounded-lg flex-shrink-0">
                  <Building className="w-5 h-5 text-qdhs-red" />
                </div>
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-qdhs-on-surface">アビクト北日本</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">所在地</dt>
                      <dd className="sm:col-span-2 text-qdhs-on-surface">
                        〒003-0002<br />
                    ...
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-qdhs-on-surface">011-833-4945</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">受付時間</dt>
                      <dd className="sm:col-span-2 text-qdhs-on-surface">平日 9:00〜18:00（土日祝日を除く）</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-qdhs-red">support@qdhs.live</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">受付時間</dt>
                      <dd className="sm:col-span-2 text-qdhs-on-surface">お問い合わせは24時間受付（回答は営業時間内）</dd>
                    </div>
                  </dl>
                </div>
              </div>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-qdhs-surface rounded-lg p-5">
                <h3 className="font-bold text-gray-900 mb-3">提供サービス</h3>
                <ul className="space-y-2 text-qdhs-on-surface">
                  <li className="flex items-start gap-2">
                    <span className="text-qdhs-red mt-1">•</span>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-qdhs-surface rounded-lg p-5 border-2 border-qdhs-outline">
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">基本サービス</h3>
                      <p className="text-sm text-qdhs-on-surface">
                  ...
                  <div className="bg-white rounded p-3">
                    <p className="text-sm text-qdhs-on-surface leading-relaxed">
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-qdhs-surface rounded-lg p-5">
                <p className="text-qdhs-on-surface leading-relaxed">
                  現在、有料サービスは提供しておりません。
                  今後、有料プランを導入する際は、以下の決済方法を予定しております。
                </p>
                <ul className="mt-3 space-y-2 text-qdhs-on-surface">
                  <li className="flex items-start gap-2">
                    <span className="text-qdhs-red mt-1">•</span>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-qdhs-surface rounded-lg p-5">
                ...
                <p className="text-qdhs-on-surface leading-relaxed mb-4">
                  現在提供している無料サービスについては、
                  いつでもご利用を停止いただけます。
                </p>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-qdhs-surface rounded-lg p-5">
                <p className="text-qdhs-on-surface leading-relaxed mb-3">
                  お客様の個人情報は、個人情報保護法に基づき適切に管理いたします。
                  詳細は
                  <a href="https://qdhs.live/privacy" className="text-qdhs-red hover:underline font-semibold mx-1">
                    プライバシーポリシー
                  </a>
                  をご確認ください。
                </p>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-lg">
                ...
                <div className="space-y-2 text-qdhs-on-surface text-sm leading-relaxed">
                  <p>
            ...
            <section>
              ...
              <div className="bg-qdhs-surface rounded-lg p-6 border-2 border-qdhs-outline">
                <p className="text-qdhs-on-surface leading-relaxed mb-4">
                  特定商取引法に関するご質問、その他お問い合わせは、
                  以下の方法でご連絡ください。
                </p>
                <div className="flex items-start gap-3 mb-4">
                  <Mail className="w-5 h-5 text-qdhs-red mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900 mb-1">メール</p>
                    <p className="text-qdhs-red">support@qdhs.live</p>
                    <p className="text-sm text-qdhs-on-surface-variant mt-1">お問い合わせは24時間受付（回答は営業時間内）</p>
                  </div>
                </div>
                <a
                  href="https://qdhs.live/contact"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-qdhs-red text-white rounded-lg hover:bg-qdhs-red transition-colors font-semibold"
                >
                  お問い合わせフォームへ
                </a>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-qdhs-on-surface-variant text-center">
              最終更新日: 2025年1月15日
            </p>
          </div>
        </div>
