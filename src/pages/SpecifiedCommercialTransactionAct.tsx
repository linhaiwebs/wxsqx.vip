                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-on-primary">support@nmslm.vip</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-on-background">受付時間</dt>
            ...
            <section className="border-b border-outline-variant pb-6">
              ...
              <div className="bg-slate-50  p-5">
                <p className="text-on-surface-variant leading-relaxed mb-3">
                  ...
                  詳細は
                  <a href="https://nmslm.vip/privacy" className="text-on-primary hover:underline font-semibold mx-1">
                    プライバシーポリシー
                  </a>
                  をご確認ください。
                </p>
              ...
              <div className="bg-surface-container  p-6 border-2 border-blue-200">
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-on-primary">support@nmslm.vip</p>
