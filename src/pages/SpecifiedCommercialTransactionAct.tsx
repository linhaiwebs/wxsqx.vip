        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-ehxv-100 p-3 rounded-lg">
              <FileText className="w-6 h-6 text-ehxv-700" />
            </div>
          ...
          <div className="space-y-6">
            <section className="border-b border-gray-200 pb-6">
              <div className="flex items-start gap-4">
                <div className="bg-ehxv-50 p-3 rounded-lg flex-shrink-0">
                  <Building className="w-5 h-5 text-ehxv-600" />
                </div>
                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-ehxv-600">support@ehxv.live</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">受付時間</dt>
              ...
              <div className="bg-slate-50 rounded-lg p-5">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-ehxv-600 mt-1">•</span>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-ehxv-50 rounded-lg p-5 border-2 border-ehxv-200">
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-slate-50 rounded-lg p-5">
                <p className="text-gray-700 leading-relaxed mb-3">
                  ...
                  詳細は
                  <a href="https://ehxv.live/privacy" className="text-ehxv-600 hover:underline font-semibold mx-1">
                    プライバシーポリシー
                  </a>
                  をご確認ください。
                </p>
            ...
            <section>
              ...
              <div className="bg-ehxv-50 rounded-lg p-6 border-2 border-ehxv-200">
                <p className="text-gray-700 leading-relaxed mb-4">
                  特定商取引法に関するご質問、その他お問い合わせは、
                  以下の方法でご連絡ください。
                </p>
                <div className="flex items-start gap-3 mb-4">
                  <Mail className="w-5 h-5 text-ehxv-600 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900 mb-1">メール</p>
                    <p className="text-ehxv-600">support@ehxv.live</p>
