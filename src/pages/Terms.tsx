      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-cx-surface-lowest   p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-cx-on-bg">利用規約</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-sm text-cx-on-surface-variant mb-6">最終更新日: 2025年10月21日</p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第1条（適用）</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第2条（サービスの内容）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第3条（利用上の注意事項）</h2>
              <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4">
                <p className="text-cx-on-bg font-semibold mb-2">重要な注意事項</p>
                <p className="text-cx-on-surface-variant leading-relaxed">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
                <p className="text-cx-on-bg font-semibold mb-2">AI分析の限界について</p>
                <p className="text-cx-on-surface-variant leading-relaxed mb-2">
                  当サービスで使用されるAI技術は、過去のデータやパターンに基づいて分析を行いますが、以下の限界があります：
                </p>
                <ul className="list-disc list-inside text-cx-on-surface-variant space-y-1 ml-4 text-sm">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第4条（禁止事項）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第5条（知的財産権）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第6条（免責事項）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第7条（サービスの変更・停止）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第8条（個人情報の取扱い）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第9条（規約の変更）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-cx-on-bg mb-4">第10条（準拠法および管轄裁判所）</h2>
              <p className="text-cx-on-surface-variant leading-relaxed mb-3">
