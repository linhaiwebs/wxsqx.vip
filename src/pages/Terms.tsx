      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            <p className="text-sm text-qdhs-on-surface-variant mb-6">最終更新日: 2025年10月21日</p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">第1条（適用）</h2>
              <p className="text-qdhs-on-surface leading-relaxed mb-3">
                本規約は、QDHS AI株式情報サービス（以下「当サービス」といいます）の利用に関する条件を、当サービスを利用する全ての方（以下「利用者」といいます）と株式会社アドバンティ（以下「当社」といいます）との間で定めるものです。
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-qdhs-on-surface space-y-2 ml-4">
                <li>株式銘柄の基本情報の表示</li>
                <li>株価推移のグラフ表示</li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4">
                <p className="text-qdhs-on-surface font-semibold mb-2">重要な注意事項</p>
                <p className="text-qdhs-on-surface leading-relaxed">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
                <p className="text-qdhs-on-surface font-semibold mb-2">AI分析の限界について</p>
                <p className="text-qdhs-on-surface leading-relaxed mb-2">
                  当サービスで使用されるAI技術は、過去のデータやパターンに基づいて分析を行いますが、以下の限界があります：
                </p>
                <ul className="list-disc list-inside text-qdhs-on-surface space-y-1 ml-4 text-sm">
            ...
            <section className="mb-8">
              ...
              <div className="bg-qdhs-surface border border-qdhs-outline rounded-lg p-4">
            ...
            <div className="bg-qdhs-surface rounded-lg p-6 mt-8">
