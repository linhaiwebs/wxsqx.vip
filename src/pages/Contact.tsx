        ...
        <div className="bg-white  shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-cnmb-lime/10 p-3 ">
              <Mail className="w-6 h-6 text-cnmb-lime-dark" />
            </div>
            <h1 className="text-3xl font-bold text-gray-900">お問い合わせ</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-cnmb-on-bg leading-relaxed mb-8">
              CNMB AI株式情報サービスをご利用いただき、誠にありがとうございます。
              ご質問、ご要望、不具合のご報告など、お気軽にお問い合わせください。
            </p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">受付時間</h2>
              <div className="bg-cnmb-bg  p-4 flex items-start gap-3">
                <Clock className="w-5 h-5 text-cnmb-lime-dark mt-1 flex-shrink-0" />
                <div>
                  <p className="font-semibold text-gray-900 mb-1">24時間受付</p>
                  <p className="text-sm text-cnmb-gray">
            ...
            <section className="mb-8">
              ...
              <form className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-semibold text-cnmb-on-bg mb-2">
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-semibold text-cnmb-on-bg mb-2">
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-semibold text-cnmb-on-bg mb-2">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-semibold text-cnmb-on-bg mb-2">
                  ...
                  <textarea
                    ...
                    required
                    rows={8}
                    className="w-full px-4 py-2 border border-gray-300  focus:ring-2 focus:ring-black focus:border-transparent resize-none"
                ...
                <div className="bg-gray-50  p-4">
                  <label className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      required
                      className="mt-1 w-4 h-4 text-cnmb-lime-dark border-gray-300 rounded focus:ring-black"
                    />
                    <span className="text-sm text-cnmb-on-bg">
                      <a href="/privacy" className="text-cnmb-lime-dark hover:underline">プライバシーポリシー</a>
                ...
                <button
                  type="submit"
                  className="w-full bg-black text-white font-semibold py-3 px-6  hover:bg-black transition-colors shadow-md"
                >
                  送信する
                </button>
              </form>
            ...
            <section className="mb-8">
              ...
              <p className="text-cnmb-on-bg leading-relaxed mb-3">
                よくあるご質問については、
                <a href="/faq" className="text-cnmb-lime-dark hover:underline font-semibold">FAQ（よくある質問）</a>
                のページもご参照ください。
              </p>
            </section>
            ...
            <div className="bg-cnmb-gray-light  p-6">
              <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                <Mail className="w-5 h-5" />
                運営会社情報
              </h3>
              <p className="text-sm text-cnmb-on-bg mb-2">
              ...
              <p className="text-sm text-cnmb-on-bg mb-2">
                <strong>メールアドレス:</strong> support@cnmb.live
              </p>
              <p className="text-sm text-cnmb-on-bg">
                <strong>お問い合わせ受付:</strong> 24時間受付（回答は営業時間内）
              </p>
              <p className="text-sm text-cnmb-on-bg mt-4">
                <strong>事業内容:</strong>
              </p>
              <ul className="text-sm text-cnmb-on-bg ml-5 list-disc">
