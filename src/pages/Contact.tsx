      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-background   p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-on-background">お問い合わせ</h1>
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-on-background mb-4">受付時間</h2>
              <div className="bg-surface-container  p-4 flex items-start gap-3">
                <Clock className="w-5 h-5 text-on-primary mt-1 flex-shrink-0" />
                <div>
                  <p className="font-semibold text-on-background mb-1">24時間受付</p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-on-background mb-4">お問い合わせフォーム</h2>
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full px-4 py-2 border border-outline-variant  focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="山田 太郎"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={8}
                    className="w-full px-4 py-2 border border-outline-variant  focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                ...
                <div className="bg-surface-container  p-4">
                  <label className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      required
                      className="mt-1 w-4 h-4 text-on-primary border-outline-variant rounded focus:ring-blue-500"
                    />
                    <span className="text-sm text-on-surface-variant">
                      <a href="/privacy" className="text-on-primary hover:underline">プライバシーポリシー</a>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-on-background mb-4">よくあるお問い合わせ</h2>
              <p className="text-on-surface-variant leading-relaxed mb-3">
                よくあるご質問については、
                <a href="/faq" className="text-on-primary hover:underline font-semibold">FAQ（よくある質問）</a>
                のページもご参照ください。
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-on-background mb-4">投資に関するご相談について</h2>
            ...
            <div className="bg-slate-100  p-6">
              <h3 className="font-bold text-on-background mb-3 flex items-center gap-2">
              ...
              <p className="text-sm text-on-surface-variant mb-2">
                <strong>メールアドレス:</strong> support@nmslm.vip
              </p>
              <p className="text-sm text-on-surface-variant">
              ...
              <ul className="text-sm text-on-surface-variant ml-5 list-disc">
