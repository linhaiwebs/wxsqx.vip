        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-ehxv-100 p-3 rounded-lg">
              <Shield className="w-6 h-6 text-ehxv-700" />
            </div>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                EHXV AI株式情報サービス（以下「当サービス」）の運営者である株式会社アドバンティ（以下「当社」）は、利用者の個人情報の重要性を認識し、
            ...
            <section className="mb-8">
              ...
              <div className="bg-ehxv-50 border-l-4 border-ehxv-500 p-4 mb-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  利用者は、<a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-ehxv-600 hover:underline">Googleの広告設定ページ</a>で、
