        ...
        <div className="bg-mb-bg   p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-blue-100 p-3 ">
              <Shield className="w-6 h-6 text-mb-cyan" />
            </div>
            <h1 className="text-3xl font-bold text-mb-on-bg">プライバシーポリシー</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-sm text-mb-on-surface-variant mb-6">最終更新日: 2025年11月25日</p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">1. 基本方針</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">2. 収集する情報</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">3. 情報の利用目的</h2>
              <p className="text-mb-on-surface-variant leading-relaxed mb-3">
                収集した情報は、以下の目的で利用します：
              </p>
              <ul className="list-disc list-inside text-mb-on-surface-variant space-y-2 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">4. Google AdSense について</h2>
              <div className="bg-mb-surface-container border-l-4 border-blue-500 p-4 mb-4">
                <p className="text-mb-on-bg font-semibold mb-2">第三者配信事業者による広告配信</p>
                <p className="text-mb-on-surface-variant leading-relaxed mb-3">
                  当サービスでは、Google AdSense を使用して広告を配信しています。
                  Google AdSense は Cookie を使用して、利用者が当サイトや他のサイトにアクセスした際の情報に基づいて広告を配信します。
                </p>
                <p className="text-mb-on-surface-variant leading-relaxed">
                  利用者は、<a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-mb-cyan hover:underline">Googleの広告設定ページ</a>で、
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">5. Cookie の使用について</h2>
              <p className="text-mb-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">6. 第三者への情報提供</h2>
              <p className="text-mb-on-surface-variant leading-relaxed mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">7. セキュリティ</h2>
              <p className="text-mb-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">8. 個人情報の開示・訂正・削除</h2>
              <p className="text-mb-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">9. 未成年者の利用</h2>
              <p className="text-mb-on-surface-variant leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-mb-on-bg mb-4">10. プライバシーポリシーの変更</h2>
              <p className="text-mb-on-surface-variant leading-relaxed">
