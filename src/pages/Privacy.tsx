        ...
        <div className="bg-white  shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-cnmb-bg border-l-4 border-black p-4 mb-4">
                <p className="text-cnmb-on-bg font-semibold mb-2">第三者配信事業者による広告配信</p>
                <p className="text-cnmb-on-bg leading-relaxed mb-3">
                  当サービスでは、Google AdSense を使用して広告を配信しています。
                  Google AdSense は Cookie を使用して、利用者が当サイトや他のサイトにアクセスした際の情報に基づいて広告を配信します。
                </p>
                <p className="text-cnmb-on-bg leading-relaxed">
                  利用者は、<a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-cnmb-lime-dark hover:underline">Googleの広告設定ページ</a>で、
