        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-qdhs-red/10 p-3 rounded-lg">
              <Shield className="w-6 h-6 text-qdhs-red" />
            </div>
            <h1 className="text-3xl font-bold text-gray-900">プライバシーポリシー</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-sm text-qdhs-on-surface-variant mb-6">最終更新日: 2025年11月25日</p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">1. 基本方針</h2>
              <p className="text-qdhs-on-surface leading-relaxed">
                QDHS AI株式情報サービス（以下「当サービス」）の運営者である株式会社アドバンティ（以下「当社」）は、利用者の個人情報の重要性を認識し、
            ...
            <section className="mb-8">
              ...
              <div className="bg-qdhs-surface border-l-4 border-qdhs-red p-4 mb-4">
                <p className="text-qdhs-on-surface font-semibold mb-2">第三者配信事業者による広告配信</p>
                <p className="text-qdhs-on-surface leading-relaxed mb-3">
                  当サービスでは、Google AdSense を使用して広告を配信しています。
                  Google AdSense は Cookie を使用して、利用者が当サイトや他のサイトにアクセスした際の情報に基づいて広告を配信します。
                </p>
                <p className="text-qdhs-on-surface leading-relaxed">
                  利用者は、<a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-qdhs-red hover:underline">Googleの広告設定ページ</a>で、
