...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-xnw-bg">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-4 border-xnw-surface-highest border-t-xnw-cyan mb-4"></div>
      <p className="text-xnw-on-bg text-xs font-display uppercase" style={{ letterSpacing: '0.1em', fontWeight: 700 }}>LOADING...</p>
    </div>
  </div>
);
