...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-background">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-2 border-surface-container-highest border-t-primary-fixed-dim rounded-full mb-4"></div>
      <p className="text-on-surface-variant font-data-mono text-data-mono">読み込み中...</p>
    </div>
  </div>
);
