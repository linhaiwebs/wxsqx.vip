...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-xb-bg">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-2 border-xb-surface-highest border-t-xb-primary rounded-full mb-4"></div>
      <p className="text-xb-on-bg font-body text-xs">読み込み中...</p>
    </div>
  </div>
);
