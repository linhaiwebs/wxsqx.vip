...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-white">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-4 border-cnmb-gray-light border-t-black mb-4"></div>
      <p className="text-cnmb-on-bg text-lg font-display uppercase tracking-widest">LOADING...</p>
    </div>
  </div>
);
