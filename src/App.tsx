...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-cbx-bg">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-4 border-cbx-surface-highest border-t-cbx-lime mb-4"></div>
      <p className="text-cbx-on-bg text-sm font-body uppercase" style={{ letterSpacing: '0.1em', fontWeight: 700 }}>LOADING...</p>
    </div>
  </div>
);
