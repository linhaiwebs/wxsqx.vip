...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-kw-bg">
    <div className="text-center">
      <div className="inline-block animate-spin h-12 w-12 border-4 border-kw-surface-highest border-t-kw-accent mb-4"></div>
      <p className="text-kw-on-bg text-xs font-display uppercase" style={{ letterSpacing: '0.1em', fontWeight: 700 }}>LOADING...</p>
    </div>
  </div>
);
